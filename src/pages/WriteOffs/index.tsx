...
import {WriteOffsTable} from "../../components/organisms/WriteOffsTable";
import {CreateWriteOffModal} from "../../components/molecules/CreateWriteOffModal";

export const WriteOffs: FC = ({onCreateSuccess}) => {
